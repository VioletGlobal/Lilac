...
import com.lilac.core.R;
import com.lilac.core.slideback.callback.OnInternalStateListener;
import com.lilac.core.slideback.callback.OnSlideListener;
...
public class SlideBackHelper {
    ...
    public static SlideBackLayout attach(@NonNull final Activity curActivity, @NonNull final ActivityHelper helper, @Nullable final SlideConfig config, @Nullable final OnSlideListener listener) {
        ...
        final ViewGroup dectorView = getDecorView(curActivity);
        final View contentView = dectorView.getChildAt(0);
        dectorView.removeViewAt(0);

        View content = contentView.findViewById(android.R.id.content);
        if (content.getBackground() == null) {
            content.setBackground(dectorView.getBackground());
        }
        ...
        dectorView.addView(slideBackLayout);
